...
void main(void){
    ...
    while(1){
        ...
        if (detected_colour == 1){ turnLeft90(&motorL,&motorR);_delay((unsigned long)((100)*(64000000/4000.0)));}
        if (detected_colour == 2){ turnRight180(&motorL,&motorR);_delay((unsigned long)((100)*(64000000/4000.0)));}
        if (detected_colour == 3){ reverseTurnRight90(&motorL,&motorR);_delay((unsigned long)((100)*(64000000/4000.0)));}
